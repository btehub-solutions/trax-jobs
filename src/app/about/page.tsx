        ...
        <section className="w-full bg-white py-20 sm:py-28 border-b border-zinc-200">
          <div className="max-w-[1360px] mx-auto px-6 sm:px-10 lg:px-16">
            ...
            <div className="w-full bg-[#fdf2ee] border border-[#fce8e0] rounded-none pt-12 sm:pt-16 px-4 sm:px-8 overflow-hidden relative shadow-[0_2px_16px_rgba(0,0,0,0.02)]">
              ...
              {/* 7 Arched Team Portrait Cards: 3x2 + 1 centered on mobile, 7 in 1 row on desktop */}
              <div className="max-w-4xl lg:max-w-[1280px] mx-auto grid grid-cols-3 lg:grid-cols-7 gap-2.5 xs:gap-3 sm:gap-6 lg:gap-3 xl:gap-5 gap-y-7 xs:gap-y-8 sm:gap-y-12 lg:gap-y-0 items-end relative z-10">
                ...
                <div className="flex flex-col items-center w-full col-start-2 lg:col-start-auto lg:order-5">
                  ...
                  <div className="h-[235px] xs:h-[290px] sm:h-[355px] lg:h-[370px] xl:h-[400px] w-full bg-[#1F1F1F] rounded-t-[55px] xs:rounded-t-[75px] sm:rounded-t-[115px] lg:rounded-t-[65px] xl:rounded-t-[80px] rounded-b-xl lg:rounded-b-none relative overflow-hidden flex items-end group shadow-sm">
                    <Image
                      ...
                      priority
                      sizes="(max-width: 768px) 34vw, 220px"
                      className="object-cover object-[center_12%] group-hover:scale-105 transition-transform duration-300"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
                  </div>
                </div>
