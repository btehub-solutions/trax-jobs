...
const TALENT_STEPS = [
  {
    step: "01",
    title: "Introduce Yourself to the Talent Desk",
    description:
      "Click Contact Editorial Team below to initiate an inquiry. Share your primary discipline, current location, and availability.",
  },
  {
    step: "02",
    title: "Editorial Portfolio & Metrics Review",
    description:
      "Our team reviews your GitHub repositories, live product URLs, Figma design files, and tangible project metrics to verify seniority.",
  },
  {
    step: "03",
    title: "Featured Profile Directory Listing",
    description:
      "Once approved, your profile is published in the curated Hire a Talent directory, allowing hiring managers to reach out directly.",
  },
];

const TALENT_CHECKLIST = [
  {
    title: "Core Specialization & Stack",
    detail: "Primary focus such as Full-Stack TypeScript, Mobile Flutter, UI/UX Systems, or Cloud Infrastructure.",
    icon: Code,
  },
  {
    title: "Tangible Project Metrics",
    detail: "Concrete achievements (for example, +42% conversion, 50k MAU scaled, or $20M payments processed).",
    icon: Star,
  },
  {
    title: "Verified Portfolio & Code Repos",
    detail: "Live links to GitHub profile, Figma case studies, published apps, or personal engineering blog.",
    icon: GlobeHemisphereWest,
  },
  {
    title: "Direct Contact Preference",
    detail: "Your direct WhatsApp number or professional email where employers can contact you directly.",
    icon: UsersThree,
  },
];
        ...
        <section className="relative overflow-hidden bg-white border-b border-zinc-200/80 pt-12 pb-16 sm:pt-16 sm:pb-20">
          ...
          <div className="max-w-[1200px] mx-auto px-6 sm:px-10 relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#fce8e0] text-[#E7040D] text-[12px] font-bold tracking-wider uppercase mb-6">
              ...
              <span>Trax Vetted Talent Network</span>
            </div>

            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#1F1F1F] tracking-[-0.02em] leading-[1.15] max-w-3xl mb-6">
              Join the Curated African Tech Talent Directory
            </h1>

            <p className="text-base sm:text-lg text-zinc-600 leading-[1.7] max-w-2xl mb-8">
              Trax connects high-impact African engineers, product designers, and technical leaders directly with venture-backed startups and hiring teams. We review every profile individually before adding talent to our curated public directory.
            </p>

            {/* Direct Action Buttons */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link
                href="/about?tab=contact&topic=profile"
              ...
              <a
                href="https://wa.me/2348000008729?text=Hello%20Trax%20Talent%20Desk%2C%20I%20would%20like%20to%20submit%20my%20talent%20profile"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                <span>Chat with Talent Desk on WhatsApp</span>
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-12 mt-12 border-t border-zinc-200/80">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="text-[14.5px] font-bold text-[#1F1F1F]">100% Free for Talent</h4>
                  <p className="text-[13px] text-zinc-500 leading-relaxed mt-0.5">
                    No placement cuts, commission, or salary deductions of any kind.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="text-[14.5px] font-bold text-[#1F1F1F]">Direct Employer Inquiries</h4>
                  <p className="text-[13px] text-zinc-500 leading-relaxed mt-0.5">
                    Hiring managers reach out directly to your personal WhatsApp or email.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="text-[14.5px] font-bold text-[#1F1F1F]">Editorial Card Polish</h4>
                  <p className="text-[13px] text-zinc-500 leading-relaxed mt-0.5">
                    We format your track record into a publication-grade profile card.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-[1200px] mx-auto px-6 sm:px-10">
            <div className="max-w-2xl mb-12">
              <div className="text-[12px] font-black text-[#E7040D] tracking-wider uppercase mb-2">
                Curated Talent Onboarding
              </div>
              <h2 className="text-2xl sm:text-3xl font-black text-[#1F1F1F] tracking-tight">
                How We Feature You on Trax
              </h2>
              <p className="text-[15px] text-zinc-600 leading-relaxed mt-2">
                Our editorial team handles profile formatting and directory publishing manually to safeguard quality and reputation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-5 space-y-4">
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-[#1F1F1F] tracking-tight leading-tight">
                  What to Prepare for the Talent Desk
                </h2>
                <p className="text-[14.5px] text-zinc-600 leading-relaxed">
                  To ensure rapid editorial review, please prepare your primary portfolio links and highlight metrics before reaching out.
                </p>
        ...
        <section className="py-12 bg-[#FAF8F5] border-b border-zinc-200/80">
          <div className="max-w-[1200px] mx-auto px-6 sm:px-10 text-center space-y-6">
            <p className="text-xs font-bold uppercase tracking-wider text-zinc-500">
              Where Trax talent works across the African continent
            </p>
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
              {TRUSTED_EMPLOYERS.map((partner) => (
                <div
                  key={partner.name}
        ...
        <section className="py-16 bg-[#1F1F1F] text-white">
          <div className="max-w-[1000px] mx-auto px-6 sm:px-10 text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white text-xs font-bold uppercase tracking-wider">
              <User size={14} weight="fill" className="text-[#E7040D]" />
              <span>Ready to be featured?</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-white max-w-xl mx-auto">
              Get in Touch with the Trax Talent Desk
            </h2>
            <p className="text-zinc-400 text-sm sm:text-base max-w-lg mx-auto leading-relaxed">
              Introduce yourself and your craft. Once vetted, your profile card will be featured in our directory for top startups to discover.
            </p>
