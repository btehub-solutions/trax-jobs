...
export default function CourseDetailPage({ params }: PageProps) {
  ...
  const whatsappUrl = `https://wa.me/2348000008729?text=${whatsappMessage}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="w-full pt-2">
              ...
              {activeTab === "overview" && (
                <div className="py-6 text-zinc-800">
              ...
              {/* Tab 2: Certificates (100% exact copy of reference screenshot) */}
              {activeTab === "certificates" && (
            ...
            <div className="bg-white rounded-none border border-zinc-200 shadow-none p-6 space-y-6">
              ...
              <div className="space-y-3.5 text-[14px]">
                ...
                <div className="flex items-center justify-between text-zinc-600">
                  ...
                  <span className="text-zinc-900 font-normal">{course.language}</span>
                </div>
                ...
                <div className="flex items-center justify-between text-zinc-600">
                  ...
                  <span className="text-zinc-900 font-normal">{course.platform}</span>
                </div>
              </div>
              ...
              {/* 4. Share this course section (90 degree square buttons) */}
              <div className="space-y-3 pt-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      const url = window.location.href;
                      window.open(`https://wa.me/?text=${encodeURIComponent(`Check out this course on Trax: ${course.title} - ${url}`)}`, "_blank");
                    }}
