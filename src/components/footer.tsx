...
const footerLinks: FooterSection[] = [
  {
    ...
    links: [
      ...
      { name: "Submit your profile", href: "/submit-profile" },
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Post an open job", href: "/submit-job" },
...
export function Footer() {
  return (
    <footer className="w-full bg-white relative overflow-hidden antialiased [font-synthesis:none] select-none">
      ...
      <div className="relative w-full flex justify-center items-end pt-24 md:pt-32 pb-0 z-0 overflow-hidden">
      ...
      <div className="relative w-full bg-[#161616] z-10 min-h-[380px]">
        {/* Content */}
