...
export function BrandWordmark({ brand, className = "" }: BrandWordmarkProps) {
  switch (brand) {
    ...
    case "flutterwave":
      return (
        <div className={`inline-flex items-center gap-2 text-[#FB4E2D] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
    ...
    case "moniepoint":
      return (
        <div className={`inline-flex items-center gap-2.5 text-[#0336FF] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
    ...
    case "interswitch":
      return (
        <div className={`inline-flex items-center gap-2 text-[#002D62] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
          {/* Dual overlapping circles symbol */}
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="shrink-0">
            <circle cx="9" cy="12" r="6" fill="#D92D20" />
            <circle cx="15" cy="12" r="6" stroke="#002D62" strokeWidth="2.5" fill="none" />
          </svg>
          <span className="text-[23px] sm:text-[27px] font-black tracking-[-0.025em] leading-none text-[#002D62]">
    ...
    case "kuda":
      return (
        <div className={`inline-flex items-center text-[#40196D] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
          {/* Kuda bespoke rounded lowercase wordmark with purple brand color and red accent dot */}
          <span className="text-[28px] sm:text-[33px] font-black tracking-[-0.05em] leading-none lowercase text-[#40196D]">
    ...
    case "piggyvest":
      return (
        <div className={`inline-flex items-center gap-2 text-[#083E9E] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
    ...
    case "andela":
      return (
        <div className={`inline-flex items-center gap-2 text-[#16A34A] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
    ...
    case "moove":
      return (
        <div className={`inline-flex items-center text-[#1A1A1A] hover:text-[#E7040D] hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
    ...
    case "cowrywise":
      return (
        <div className={`inline-flex items-center gap-2 text-[#0066F5] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
    ...
    case "opay":
      return (
        <div className={`inline-flex items-center gap-1.5 text-[#00B875] hover:opacity-80 hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
          {/* OPay circular emblem */}
          <svg width="23" height="23" viewBox="0 0 24 24" fill="none" className="shrink-0">
            <circle cx="12" cy="12" r="8" stroke="#00B875" strokeWidth="3.5" />
            <path d="M12 4A8 8 0 0 1 20 12" stroke="#00B875" strokeWidth="3.5" strokeLinecap="round" />
          </svg>
          <span className="text-[24px] sm:text-[28px] font-black tracking-tight leading-none text-[#1A1A1A]">
            OPay
          </span>
        </div>
      );
    ...
    case "carbon":
      return (
        <div className={`inline-flex items-center text-[#1F1F1F] hover:text-[#E7040D] hover:scale-105 transition-all duration-200 select-none shrink-0 cursor-default ${className}`}>
